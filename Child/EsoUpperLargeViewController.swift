//
//  EsoUpperLargeViewController.swift
//  Child
//
...
class EsoUpperLargeViewController: UIViewController {
    
    var vSenkyobui:Int!
    
    let LNResourceArray = ["CEUL","UTUL","MTUL","LTUL","AEUL"]
    ...
    override func viewDidLoad() {
        ...
        if let documentURL = Bundle.main.url(forResource: "LNUpperLarge", withExtension: "pdf") {
